...
describe('StarkwareWallet.fromSignature', () => {
  it('stark key', async () => {
    const sig =
      '0xfb7ae61d6b2c34de46d17830eff6bc73888f560fa4f8ab0e0de50a6f0f8a131f43b69300b96b8e2bcd42efd172a6d531ba2b39a765596fe7e1b39cc37114c1ad1b'
    const starkWallet = StarkwareWallet.fromSignature(sig, provider, store)
    const account = await starkWallet.account(layer, application, index)
    expect(account).toBe(
      '0x054acad161a80912dbd44f166ffb71ce0c7cc8655c40aae619e9eb4316973093'
    )
  })
})
